...
interface ComponentDetailProps {
  ...
  onClose: () => void;
  onFavoriteRemoved?: (componentId: number) => void;
}

export default function ComponentDetail({ component, onClose, onFavoriteRemoved }: ComponentDetailProps) {
  ...
  // Enhance the favorite handler to immediately notify parent
  const handleFavoriteChange = (isFavorite: boolean) => {
    if (!isFavorite && component) {
      // Call the parent callback immediately when favorite is removed
      if (onFavoriteRemoved) {
        onFavoriteRemoved(component.id);
      }
    }
  };
      ...
      {mounted && createPortal(
        <div className={styles.detailSidebar}>
          <div className={styles.detailHeader}>
            ...
            {/* Header actions container for favorite button */}
